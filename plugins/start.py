...
FILE_AUTO_DELETE = 600  # Example: 3600 seconds (1 hour)
TUT_VID = f"{TUT_VID}"

@Bot.on_message(filters.command('start') & filters.private & subscribed)
async def start_command(client: Client, message: Message):

    await message.reply("(っ◔◡◔)っ ♥️ \n\n𝐇𝐞𝐲, 𝗧𝗵𝗲𝗿𝗲\n\n 𝗝𝘂𝘀𝘁 𝗵𝗮𝗻𝗴 𝘁𝗶𝗴𝗵𝘁 𝗳𝗼𝗿 𝟱 𝘀𝗲𝗰𝗼𝗻𝗱𝘀 𝘄𝗵𝗶𝗹𝗲 𝗜 𝘀𝗼𝗿𝘁 𝗼𝘂𝘁 𝘆𝗼𝘂𝗿 𝗿𝗲𝗾𝘂𝗲𝘀𝘁.")
        ...
        if TOKEN:
            ...
            if "verify_" in message.text:
                ...
                return await message.reply(
                    f"🍀Your token successfully verified and valid for: 24 Hour",
            ...
            if not verify_status['is_verified']:
                ...
                return await message.reply(
                    f"𝘆𝗼𝘂'𝗿𝗲 𝗻𝗼𝘁 𝘃𝗲𝗿𝗶𝗳𝗶𝗲𝗱 𝘁𝗼𝗱𝗮𝘆. 𝗝𝘂𝘀𝘁 𝘃𝗲𝗿𝗶𝗳𝘆 𝗮𝗻𝗱 𝘆𝗼𝘂'𝗹𝗹 𝗴𝗲𝘁 𝘂𝗻𝗹𝗶𝗺𝗶𝘁𝗲𝗱 𝗮𝗰𝗰𝗲𝘀𝘀 𝘂𝗻𝘁𝗶𝗹 𝗻𝗲𝘅𝘁 𝘃𝗲𝗿𝗶𝗳𝗶𝗰𝗮𝘁𝗶𝗼𝗻",
    ...
    if len(text) > 7:
        ...
        if FILE_AUTO_DELETE > 0:
            notification_msg = await message.reply(
                f"⚠️𝗙𝗶𝗹𝗲𝘀 𝘄𝗶𝗹𝗹 𝗯𝗲 𝗱𝗲𝗹𝗲𝘁𝗲𝗱 𝗔𝗳𝘁𝗲𝗿 10 𝗺𝗶𝗻𝘀 𝘁𝗼 𝗮𝘃𝗼𝗶𝗱 𝗰𝗼𝗽𝘆𝗿𝗶𝗴𝗵𝘁𝘀. 𝗦𝗮𝘃𝗲 𝘁𝗵𝗲 𝗳𝗶𝗹𝗲𝘀 𝘁𝗼 𝗦𝗼𝗺𝗲𝘄𝗵𝗲𝗿𝗲 𝗲𝗹𝘀𝗲⚠💢"
            )
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                    [InlineKeyboardButton("• ᴍᴏʀᴇ ᴄʜᴀɴɴᴇʟs •", url="https://t.me/Dramafilez")],
