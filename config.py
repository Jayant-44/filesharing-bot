...
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://chirag:chirag@cluster0.twh4t.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5191512694").split()):
        ADMINS.append(int(x))
except ValueError:
